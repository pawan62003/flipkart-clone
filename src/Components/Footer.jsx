...
const Footer = () => {
	return (
		<>
			<Box bg="#E3DFFD" w="100%" style={{ backdropFilter: "blur(13px)" }}>
				<Grid
					py={10}
					templateColumns={{
						sm: "repeat(2,1fr)",
			...
			<Box bg={"blackAlpha.500"} color="white" display={"flex"} w="100%">
				<Box
					w={["98%", "98%", "90%"]}
					m="auto"
					p=""
					...
					<Text
						...
						whiteSpace={"nowrap"}
						letterSpacing=".1em">
						Copyright © 2021-2023 Supermarket Supplies Pvt Ltd
					</Text>
				</Box>
			</Box>
		</>
